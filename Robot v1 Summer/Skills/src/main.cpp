...
void autonomous() {
    ...
    chassis.moveToPoint(-59, -3, 500, {.forwards = false});
    chassis.waitUntilDone();
    clamp.set_value(false);

    // 2nd goal
    pros::delay(200);
    chassis.moveToPoint(-55, -18, 700);
    intake.brake();

    chassis.turnToHeading(270, 700);
    chassis.moveToPose(19, -8, 255, 2500, {.forwards = false, .minSpeed = 70});
    pros::delay(200);
    chassis.moveToPoint(21, -6.5, 600, {.forwards = false, .maxSpeed = 60});
    chassis.waitUntilDone();
    clamp.set_value(true);
    ...
    // Wall stake
    chassis.moveToPoint(60, -52, 700, {.forwards = false, .maxSpeed = 60});
    ...
    chassis.moveToPoint(72.5, -52.5, 1000, {.maxSpeed = 60});
    chassis.waitUntilDone();
    ...
    // Goal
    chassis.turnToPoint(13, -102, 800, {.forwards = false});
    chassis.moveToPoint(13, -102, 1500, {.forwards = false, .maxSpeed = 60});
    chassis.waitUntilDone();
    clamp.set_value(true);
    ...
    chassis.moveToPose(68, -116, 90, 2000, {.minSpeed = 90});
