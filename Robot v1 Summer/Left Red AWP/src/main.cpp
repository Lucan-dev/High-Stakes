...
void autonomous() {
    // Goal
    chassis.moveToPoint(0, -28, 1000, {.forwards = false, .maxSpeed = 60});
    ...
    // Ring
    chassis.turnToPoint(19, -24, 800);
    chassis.moveToPoint(19, -24, 800);

    chassis.turnToPoint(25, -36, 800);
    chassis.moveToPoint(25, -36, 800);
    pros::delay(500);

    // Pole
    chassis.turnToPoint(-1.5, -45, 700, {.forwards = false});
    chassis.moveToPoint(-1.5, -45, 1000, {.forwards = false});
