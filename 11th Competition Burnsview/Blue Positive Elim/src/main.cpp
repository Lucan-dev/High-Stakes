...
void autonomous() {
    ...
    // 1st Ring
    chassis.turnToPoint(-22.5, -2, 800);
    chassis.moveToPoint(-22.5, -2, 1500, {.maxSpeed = 60});
    ...
    // 2nd Ring
    chassis.moveToPoint(-23, -12.5, 800, {.forwards = false, .maxSpeed = 120});

    chassis.turnToPoint(-17, -43, 800, {.maxSpeed = 80});
    chassis.moveToPoint(-17, -43, 1000);

    // 3rd Ring
    chassis.moveToPose(29, -45, 68, 2000, {.minSpeed = 100});

    chassis.waitUntilDone();
    pros::delay(500);
    chassis.moveToPoint(-11, -55.5, 2000, {.forwards = false, .maxSpeed = 80});

    chassis.turnToPoint(-17, -62, 800);
    chassis.moveToPoint(-17, -62, 800);
