...
void autonomous() {
    ...
    // 2nd Goal
    pros::delay(500);
    chassis.moveToPoint(-13, -57, 1200);

    chassis.turnToPoint(-1.6, -60.5, 900, {.forwards = false});
    chassis.moveToPoint(-1.6, -60.5, 1500, {.forwards = false, .maxSpeed = 60});
    ...
    // Leave
    pros::delay(500);
    chassis.turnToPoint(26, -31, 900);
    chassis.moveToPoint(26, -31, 1200);
}
