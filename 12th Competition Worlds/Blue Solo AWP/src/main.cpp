...
void autonomous() {
    ...
    chassis.moveToPoint(28.5, -62, 1500, {.maxSpeed = 80});
    ...
    chassis.moveToPoint(61.5, 32.5, 1500);
    color_sort_task = new pros::Task(colorSort);

    // Touch Bar
    chassis.waitUntilDone();
    pros::delay(200);
    chassis.turnToPoint(55, -0.5, 800, {.forwards = false, .minSpeed = 10});

    chassis.moveToPoint(55, -0.5, 2000, {.forwards = false, .minSpeed = 40});
    chassis.waitUntil(4);
    armTo(110);
