...
void autonomous() {
    ...
    // 3rd Ring
    chassis.moveToPoint(-33, -46.5, 800, {.forwards = false, .minSpeed = 30});
    
    chassis.turnToPoint(-24, -48.5, 800, {.minSpeed = 10});
    chassis.moveToPoint(-24, -48.5, 1000, {.minSpeed = 30});
    ...
    // Touch Bar
    chassis.moveToPoint(-24, -29.5, 2500, {.forwards = false, .maxSpeed = 80});
    chassis.waitUntilDone();
    pros::delay(1000);
