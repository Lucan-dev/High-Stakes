...
void autonomous() {
    ...
    // 1st Ring
    chassis.turnToPoint(-22.5, -2.5, 800);
    chassis.moveToPoint(-22.5, -2.5, 1500, {.maxSpeed = 60});
    ...
    chassis.turnToPoint(-17, -43, 2000, {.maxSpeed = 40});
    chassis.moveToPoint(-17, -43, 1000);

    // 3rd Ring
    chassis.moveToPose(27, -45.5, 68.5, 2500, {.minSpeed = 100});
    chassis.waitUntilDone();
    ...
    chassis.waitUntilDone();
    pros::delay(400);
    chassis.turnToPoint(-43, -24.5, 1000,{.forwards = false});
    chassis.moveToPoint(-43, -24.5, 5000, {.forwards = false, .maxSpeed = 80});
