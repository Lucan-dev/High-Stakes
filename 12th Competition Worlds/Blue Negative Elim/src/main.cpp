...
void autonomous() {
    ...
    chassis.moveToPoint(29, -59, 1000, {.maxSpeed = 80});
    ...
    // Corner Ring
    chassis.turnToPoint(-8.5, -44.5, 800, {.minSpeed = 10});
    chassis.moveToPoint(-8.5, -44.5, 1000, {.minSpeed = 10, .earlyExitRange = 4});

    chassis.moveToPoint(-25, -42.5, 2500, {.minSpeed = 10});

    // 5th Ring
    chassis.moveToPoint(-7, -36, 800, {.forwards = false, .minSpeed = 10});

    chassis.turnToPoint(11, -6.5, 800, {.minSpeed = 10});
    chassis.moveToPoint(11, -6.5, 1000, {.minSpeed = 120, .earlyExitRange = 10});
    chassis.moveToPoint(28.5, 23.5, 2000, {.maxSpeed = 100});
