...
void autonomous() {
    ...
    // Goal
    chassis.turnToPoint(27, -24, 1000, {.forwards = false});
    chassis.moveToPoint(27, -24, 2000, {.forwards = false, .maxSpeed = 50});
    chassis.waitUntilDone();
    clamp.set_value(true);

    // 1st Ring
    pros::delay(200);
    chassis.turnToPoint(16.5, -42.5, 1000);
    ...
    chassis.turnToPoint(38, -19, 1000);
    chassis.moveToPoint(38, -19, 2000);
    intake.brake();
