...
void autonomous() {
    ...
    // Wallstake Ring
    chassis.turnToPoint(59.5, 64.5, 1000);
    chassis.moveToPoint(59.5, 64.5, 2000);

    while (arm_rotation.get_position() / -100 < 105) {
        arm.move(30);
    }
    arm.brake();
    ...
    chassis.moveToPoint(45, 5, 2500, {.maxSpeed = 100});

    chassis.turnToPoint(58, 15, 1000);
    chassis.moveToPoint(58, 15, 1000);

    // Place goal in corner
    chassis.turnToPoint(60, 6, 1000, {.forwards = false});
    chassis.moveToPoint(60, 6, 1000, {.forwards = false, .minSpeed = 20});
    ...
    chassis.turnToPoint(15.5, 19, 1000, {.forwards = false});
    chassis.moveToPoint(-15.5, 19, 2000, {.forwards = false});
    intake.brake();

    chassis.moveToPoint(-24, 19, 800, {.forwards = false, .maxSpeed = 60});
    ...
    // 2nd Wallstake Ring
    chassis.turnToPoint(-60.5, 70.5, 1000);
    chassis.moveToPoint(-60.5, 70.5, 2000);
    ...
    chassis.turnToPoint(-50, 91, 1000);
    intake.move(127);
    chassis.moveToPoint(-50, 91, 1000);

    // 3 More Rings
    chassis.turnToPoint(-50, 13, 1000);
    chassis.moveToPoint(-50, 13, 2500, {.maxSpeed = 100});

    // Last Ring
    chassis.turnToPoint(-64, 25, 1000);
    chassis.moveToPoint(-64, 25, 1000);

    // Place 2nd Goal in Corner
    chassis.turnToPoint(-66, 16, 1000, {.forwards = false});
    chassis.moveToPoint(-66, 16, 1000, {.forwards = false});
    ...
    // 1st Ring
    chassis.moveToPose(-27, 94, 35, 3000, {.minSpeed = 100});

    chassis.waitUntil(20);
    intake.move(127);

    // Push 3rd goal into corner
    chassis.turnToPoint(-24, 125, 1000);
    pros::delay(100);
    intake.brake();
    chassis.moveToPoint(-24, 125, 1000);

    chassis.swingToHeading(-100, lemlib::DriveSide::LEFT, 1000);
    chassis.moveToPoint(-53, 136, 1200);

    // Get 4th goal
    chassis.moveToPoint(-2, 118, 4000, {.forwards = false, .maxSpeed = 70});
    chassis.waitUntilDone();
    clamp.set_value(true);

    // 1 ring
    pros::delay(200);
    chassis.turnToPoint(23, 92, 1000);
    chassis.moveToPoint(23, 92, 1000);
    intake.move(127);

    // Place goal in corner
    chassis.turnToPoint(60, 89, 1000);
    chassis.moveToPoint(60, 89, 1000);
